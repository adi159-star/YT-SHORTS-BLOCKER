...
A simple Chrome extension that hides YouTube Shorts content on YouTube when the extension is enabled.
...
6. Select the extracted YT-Shorts-Blocker folder.
7. Open YouTube and refresh the page.
